 ...
 * FizzBuzz Challenge
 * 
 * Original source: https://github.com/PEPLabs/FizzBuzz
 * 
 * Return "Fizz" if a number n is divisible by 3, "Buzz" if divisible by 5, 
 * and "FizzBuzz" if divisible by both.
 *
 * This is a coding problem that will make use of the modulus (%) operator, which can help us calculate if a number
 ...
 */
public class FizzBuzz implements FizzBuzzSolution {
