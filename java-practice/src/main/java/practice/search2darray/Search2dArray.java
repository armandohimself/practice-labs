package practice.search2darray;

/**
 * Original source: PEPLabs/Search2dArray
 * Adapted for practice-labs
 */


public class Search2dArray implements Search2dArraySolution {
    /**
