...
public class Palindrome {
    ...
    public boolean pal(String str){
        ...
        // Method that compares each character
        // for(int i = 0; i < str.length(); i++) {
        //     if(compare.charAt(i) != str.charAt(i)) return false; 
        // }

        // Method that compares entire string
        //if(!compare.equals(str)) return false;
        
        // Method on one line using StringBuilder
